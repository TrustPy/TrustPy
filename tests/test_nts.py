...
def test_predictions_out_of_bounds():
...
def test_predictions_not_softmax():
...
def test_known_output():
    ...
    assert float(scores["overall"]) == 0.775
...
def test_all_incorrect():
    ...
    assert float(scores["overall"]) == 0.2
